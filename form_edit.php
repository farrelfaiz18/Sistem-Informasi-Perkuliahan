<?php
    ...
    if(isset($_GET['nim'])) {
        $nim = $_GET['nim'];
        $query = mysqli_query($conn, "SELECT * FROM mhs_web WHERE nim='$nim'");
        ...
        <form action="update.php" method="POST" >
            ...
            <div class="form-group">
                ...
                <select name="status">
                    ...
                    <option value="2" <?php if($data['status'] == '2') echo 'selected'; ?>>Cuti</option>
                    <option value="3" <?php if($data['status'] == '3') echo 'selected'; ?>>Alpa Studi</option>
                    <option value="4" <?php if($data['status'] == '4') echo 'selected'; ?>>Semhas</option>
                    <option value="5" <?php if($data['status'] == '5') echo 'selected'; ?>>Kompre</option>
                    <option value="6" <?php if($data['status'] == '6') echo 'selected'; ?>>Alumni</option>
                </select>
            </div>
            <div class="form-group">
                <label>Alamat:</label>

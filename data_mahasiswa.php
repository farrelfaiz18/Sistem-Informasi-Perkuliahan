...
<body>
    ...
    <div class="container">
        ...
        <div class="column column-kanan table-container">
            ...
            <form id="search" action="data_mahasiswa.php" method="get">
                <p>
                ...
                foreach ($mahasiswa as $row){
                    ...
                    echo"<td>$status</td><td>$row[alamat]</td>
                        <td style='text-align:center;'>
                            <a href=form_edit.php?nim=$row[nim] style='text-decoration:none;'>Edit</a>&nbsp;|&nbsp;
                            <a href=delete.php?nim=$row[nim] style='text-decoration:none;'>Delete</a>
                        </td>
                    </tr>";
                    $no++;
                }
